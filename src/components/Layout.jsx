        ...
        <div className="size-16 flex justify-center items-center rounded-full hover:bg-slate-600 cursor-pointer transition-colors bg-primary">
          ...
          >
            <svg
              ...
              fill="currentColor"
              className="size-7 text-white bi bi-instagram"
              viewBox="0 0 16 16"
            >
        ...
        <div className="size-16 flex justify-center items-center rounded-full hover:bg-slate-600 cursor-pointer transition-colors bg-primary">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="size-7 text-white bi bi-github"
              viewBox="0 0 16 16"
            >
        ...
        <div className="size-16 flex justify-center items-center rounded-full hover:bg-slate-600 cursor-pointer transition-colors bg-primary">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="size-7 text-white bi bi-telegram"
              viewBox="0 0 16 16"
            >
