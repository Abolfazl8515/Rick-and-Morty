  ...
  return (
    <div>
      ...
      <div className="w-full h-screen relative">
        ...
        <div className="xl:w-3/5 lg:w-4/5 w-5/6 h-auto flex mt-24 mobile:flex-col-reverse sm:flex-row items-center justify-center mx-auto">
      ...
      <main className="w-full h-auto flex items-center justify-start flex-col relative top-24">
